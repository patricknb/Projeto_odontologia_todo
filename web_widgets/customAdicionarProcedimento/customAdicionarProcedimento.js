(function () {
...
})().directive('customAdicionarProcedimento', function() {
    return {
      controllerAs: 'ctrl',
  ...
  function submitTask() {
    if ($scope.properties.SourceVariable == null){
        $scope.properties.TargetVariable += "";
    } else {
        $scope.properties.TargetVariable += $scope.properties.SourceVariable + ",";
    }
    }
